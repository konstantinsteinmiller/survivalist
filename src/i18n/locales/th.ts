export default {
  ...
  'upgrades': {
    ...
    'names': {
      ...
      'rocket': 'พลังจรวด',
      'gatling': 'พลังแกตลิง',
      'grapeshot': 'พลังลูกซอง',
      'dynamo': 'พลังไดนาโม',
      'gravecall': 'พลังเรียกวิญญาณ',
      'hoard': 'พลังสมบัติ'
    },
    'descriptions': {
      ...
      'grapeshot': 'ปืนลูกซองที่ปลดล็อกในด่านสร้างความเสียหายมากขึ้น',
      'dynamo': 'สายฟ้าไดนาโมที่ปลดล็อกในด่านโจมตีแรงขึ้น',
      'gravecall': 'ศพที่คุณปลุกขึ้นมาสู้เก่งขึ้นและอยู่ได้นานขึ้น',
      'hoard': 'ศัตรูที่กลายเป็นทองให้เหรียญมากขึ้น'
    }
  },
