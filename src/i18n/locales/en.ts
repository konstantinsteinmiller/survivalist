...
export default {
  ...
  'tech': {
    ...
    'descriptions': {
      'foundations': 'Every block starts with +10% HP.',
      'sharpBolts': 'All weapons deal +8% damage per rank.',
      'unlockBrace': 'Unlocks the Braced Crate — twice the HP of plain wood.',
      'lumberStock': 'Start each siege with +25 wood per rank.',
      'longSight': 'All weapons reach +10% further per rank.',
      'rapidFire': 'All weapons fire 8% faster per rank.',
      'reinforced': 'Every block gains +8% HP per rank.',
      'unlockSawmill': 'Unlocks the Sawmill — produces wood each wave.',
      'quarryStock': 'Start each siege with +18 stone per rank.',
      'unlockMortar': 'Unlocks the Mortar — long-range arcing splash.',
      'heavyOrdnance': 'Splash radius +15% per rank.',
      'unlockTesla': 'Unlocks the Lightning Coil — bolts fork between enemies.',
      'gateArmor': 'The Gate gains +20% HP per rank.',
      'unlockQuarry': 'Unlocks the Quarry — produces stone each wave.',
      'richHauls': 'Wave rewards +12% per rank.',
      'wideFoundation': 'Build 2 columns wider per rank.',
      'siegeShells': 'All weapons deal +10% damage per rank.',
      'unlockFrost': 'Unlocks the Frost Spire — slows whole clusters.',
      'forkedBolts': 'Lightning forks to 1 extra enemy per rank.',
      'ironPlating': 'Every block gains +2 armour per rank.',
      'unlockRepair': 'Unlocks the Repair Bay — heals neighbours each wave.',
      'unlockMint': 'Unlocks the Gold Mine — produces coins each wave.',
      'looting': 'Enemies drop +15% more coins per rank.',
      'overcharge': 'All weapons fire 10% faster per rank.',
      'masterwork': 'All weapons deal +12% damage per rank.',
      'fieldRepairs': 'Every block heals 6% of its max HP per cleared wave, per rank.',
      'greatFoundation': 'Build 2 more columns wider per rank.',
      'warChest': 'Wave rewards +15% per rank.',
      ...
      'sharpSpikes': 'Spiked walls reflect +20% more damage per rank.',
      'cavalryDrill': 'Cavalry ride out with +14% HP and damage per rank.',
      'artilleryDoctrine': 'All weapons reach +9% further per rank.'
    }
  },
