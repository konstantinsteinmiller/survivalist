export default {
  ...
  'tech': {
    ...
    'descriptions': {
      'foundations': 'Jeder Block startet mit +10 % TP.',
      'sharpBolts': 'Alle Waffen verursachen +8 % Schaden pro Rang.',
      'unlockBrace': 'Schaltet die verstärkte Kiste frei – doppelte TP von Holz.',
      'lumberStock': 'Starte jede Belagerung mit +25 Holz pro Rang.',
      'longSight': 'Alle Waffen reichen +10 % weiter pro Rang.',
      'rapidFire': 'Alle Waffen feuern 8 % schneller pro Rang.',
      'reinforced': 'Jeder Block erhält +8 % TP pro Rang.',
      'unlockSawmill': 'Schaltet das Sägewerk frei – produziert jede Welle Holz.',
      'quarryStock': 'Starte jede Belagerung mit +18 Stein pro Rang.',
      'unlockMortar': 'Schaltet den Mörser frei – weitreichender Flächenschaden.',
      'heavyOrdnance': 'Splash-Radius +15 % pro Rang.',
      'unlockTesla': 'Schaltet die Blitzspule frei – Blitze springen über.',
      'gateArmor': 'Das Tor erhält +20 % TP pro Rang.',
      'unlockQuarry': 'Schaltet den Steinbruch frei – produziert jede Welle Stein.',
      'richHauls': 'Wellenbelohnungen +12 % pro Rang.',
      'wideFoundation': 'Baue 2 Spalten breiter pro Rang.',
      'siegeShells': 'Alle Waffen verursachen +10 % Schaden pro Rang.',
      'unlockFrost': 'Schaltet die Frostspitze frei – verlangsamt ganze Gruppen.',
      'forkedBolts': 'Blitze springen auf 1 zusätzlichen Gegner pro Rang.',
      'ironPlating': 'Jeder Block erhält +2 Panzerung pro Rang.',
      ...
      'looting': 'Gegner lassen +15 % mehr Münzen fallen pro Rang.',
      'overcharge': 'Alle Waffen feuern 10 % schneller pro Rang.',
      'masterwork': 'Alle Waffen verursachen +12 % Schaden pro Rang.',
      'fieldRepairs': 'Jeder Block heilt 6 % seiner max. TP pro gehaltener Welle und Rang.',
      'greatFoundation': 'Baue 2 weitere Spalten breiter pro Rang.',
      'warChest': 'Wellenbelohnungen +15 % pro Rang.',
      ...
      'sharpSpikes': 'Stachelwände reflektieren +20 % mehr Schaden pro Rang.',
      'cavalryDrill': 'Kavallerie reitet mit +14 % TP und Schaden pro Rang aus.',
      'artilleryDoctrine': 'Alle Waffen reichen +9 % weiter pro Rang.'
    }
  },
