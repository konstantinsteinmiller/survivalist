export default {
  ...
  'offer': {
    'confirm': 'Смотреть рекламу',
    'available': 'Посмотри видео и получи {weapon} бесплатно'
  },
  ...
  'flow': {
    ...
    'bossAhead': "Впереди босс: {name}",
    'rankUp': "Место #{rank} ▲{n}",
    'bossName': {
      'grumpling': "Ворчунок",
      'bonecap': "Костеголов",
      'snaggletusk': "Кривоклык",
      'thornwick': "Терновик",
      'marrowknight': "Костяной рыцарь",
      'cinderhound': "Пепельный пёс",
      'rattlejack': "Гремучий Джек"
    }
  ...
  'upgrades': {
    ...
    'names': {
      ...
      'grapeshot': 'Сила картечи',
      'dynamo': 'Сила Динамо',
      'gravecall': 'Сила зова могил',
      'hoard': 'Сила клада'
    },
    'descriptions': {
      ...
      'grapeshot': 'Дробовики, открытые на этапе, наносят больше урона.',
      'dynamo': 'Молнии Динамо, открытые на этапе, бьют сильнее.',
      'gravecall': 'Поднятые мертвецы сражаются сильнее и держатся дольше.',
      'hoard': 'Враги, обращённые в золото, дают больше монет.'
    }
  },
