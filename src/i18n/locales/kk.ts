export default {
  ...
  'weapons': {
    ...
    'grapeshot': 'Оқшашар',
    'dynamo': 'Динамо',
    'gravecall': 'Өлі шақыру',
    'hoard': 'Қарға қазынасы',
    'bolt': 'Найзағай'
  },
  ...
  'upgrades': {
    ...
    'names': {
      ...
      'grapeshot': 'Оқшашар күші',
      'dynamo': 'Динамо күші',
      'gravecall': 'Өлі шақыру күші',
      'hoard': 'Қазына күші'
    },
    'descriptions': {
      ...
      'grapeshot': 'Кезеңде ашылған оқшашарлар көбірек зақым келтіреді.',
      'dynamo': 'Кезеңде ашылған Динамо найзағайлары қаттырақ соғады.',
      'gravecall': 'Тірілткен өлілерің күштірек шайқасып, ұзағырақ тұрады.',
      'hoard': 'Алтынға айналған жаулар көбірек монета береді.'
    }
  },
