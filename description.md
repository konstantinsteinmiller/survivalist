# Survivalist — store copy

## Short description (129 / 150 chars)

Shoot the gates to grow them, run your crowd through, and turn three survivors
into an army before the boss turns them into dust.

## Description (471 / 500 chars)
...
3. **Gates grow while you shoot them.** A `+1` gate climbs by one every half
   second of sustained fire. Park in front of one to pump it, then run through
   to collect it.
...
| Open upgrades | Tap the **+** button (bottom right) | Click the **+** button |
| Options / language / audio | Tap the gear (bottom left) | Click the gear |
| Mute | Tap the speaker (bottom left) | Click the speaker |
| Close a panel | Tap the ✕ or outside it | **Esc** |

The game starts straight into stage 1 — there is no menu, and progress saves
itself after every stage.
